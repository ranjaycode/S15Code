...
CAPTURE_CONTENT_ENV = "S15_OTEL_CAPTURE_CONTENT"
ENDPOINT_ENV = "S15_OTEL_EXPORTER_ENDPOINT"
SERVICE_NAME_ENV = "S15_OTEL_SERVICE_NAME"
DEFAULT_SERVICE_NAME = "s15code"
...
def emit_span_tree(
    ...
    *,
    ...
    instrumentation_name: str = "s15code.telemetry",
) -> None:
