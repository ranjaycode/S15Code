...
from s15code.ui.catalog import COMPONENTS, REGISTERED_ACTIONS, catalog_manifest
from s15code.ui.fixtures import RecordedJournal
from s15code.ui.hitl import PendingAction, decide_resume
from s15code.ui.routes import router as ui_router
from s15code.ui.surface import build_run_surface
from s15code.ui.validator import Invariant, validate_surface
...
def client() -> TestClient:
    app = FastAPI()
    app.include_router(ui_router)  # exactly how s15code.main folds the UI in
...
def test_render_client_never_uses_innerhtml_and_documents_the_contract():
    html = (_BUILD_ROOT / "s15code" / "ui" / "client" / "index.html").read_text()
